...
class CreateApiConsoleControlRector extends AbstractRector
{
    ...
    public function getRuleDefinition(): RuleDefinition
    {
        return new RuleDefinition('Changes for creating ApiConsoleControl', [
            new CodeSample(
                '$apiListing = new \Tomaj\NetteApi\Component\ApiConsoleControl($this, "ApiConsoleControl", $this->apiDecider);',
                '$apiListing = new \Tomaj\NetteApi\Component\ApiConsoleControl($this->apiDecider);'
            )]
        );
    }
}
